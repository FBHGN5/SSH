...
<s:iterator value="list" var="e">
	<tr>
		...
		<td align="center"><a href="${pageContext.request.contextPath}/employee_delete.action?eid=<s:property value="#e.eid"/>"><img src="${pageContext.request.contextPath}/images/trash.gif"</a></a></td>
	</tr>
</s:iterator>
</tbody>
</table>
...
<td align="right">
   ...
   <span>
	   ...
	   <s:iterator begin="1" end="totalPage" status="st">
		   ...
		   <s:else>
			   <li class="page_three"><a href="${pageContext.request.contextPath }/employee_findAll.action?currPage=<s:property value='%{#st.index+1}'/>"><s:property value="%{#st.index+1}"></s:property></a></li>
		   </s:else>
	   </s:iterator>
